  ...
  created() {
    ...
    useHead({
      ...
      meta: [
        ...
        { property: 'og:title', content: this.hebergementSelected.title },
        { property: 'og:description', content: this.hebergementSelected.shortDesc },
        { property: 'og:image', content: this.currentUrl + this.hebergementSelected.imgs[1].link },
        { property: 'twitter:card', content: 'summary_large_image' },
        { property: 'twitter:site', content: '@erwan0711' },
        { property: 'twitter:creator', content: '@erwan0711' },
        { property: 'twitter:title', content: this.hebergementSelected.title },
        { property: 'twitter:description', content: this.hebergementSelected.shortDesc },
        { property: 'twitter:image', content: this.currentUrl + this.hebergementSelected.imgs[1].link },
      ],
      link: [
        {
          hid: 'canonical',
