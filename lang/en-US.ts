export default {
  ...
  accommodation: {
    ...
    breakfastText: [
      { text: "Le petit déjeuner est servi de 8h00 à 9h30, ou plus tôt sur demande. Il vous est proposé dans la salle à manger ou dans la cour intérieure pleine de charme, à la belle saison. Sous forme de buffet, vous retrouverez le pain traditionnel et ses viennoiseries, du thé bio, le café du torréfacteur, du jus de fruits et des yaourts locaux, ainsi que des fruits de saison." },
      { text: "Sur réservation, la table d'hôte est possible afin de partager un moment convivial et gourmand. Nous vous proposons un menu unique \"maison\" ou des planches de charcuteries, fromages, ou salade composée avec des produits locaux et bio." },
    ],
    theRoom: "La chambres",
  ...
  near: {
    ...
    toVisitDescText: [
      { text: "Au cœur de la Vallée du Rhône, à proximité de la sortie A7, à 1 h de Lyon, 50 min de Valence, et 1 h 15 de Grenoble, le domaine de Pipangaille bénéficie d'un emplacement privilégié. Cet emplacement est particulièrement apprécié par les touristes à vélo, car la ViaRhôna longe le domaine. Pour des activités en famille, telles que des randonnées à pied ou en VTT, des découvertes œnologiques sur la route des vins, la visite du Palais Idéal du Facteur Cheval, du Safari de Peaugres, du chemin de fer du Vivarais, le choix est riche et varié...", },
    ],
    ...
    toVisit: {
      ...
      AcroboisPilat: {
        ...
        longDesc: [
          { text: "Au cœur d'un bois, profitez en famille en couple ou entre amis d'une aventure sur 14 parcours pour tous les niveaux. Venez vous mettre aux défis et essayez d'atteindre et de réussir le dernier parcours. De nombreuses tyroliennes et obstacles variés sauront vous mettre à l'épreuve." },
        ],
      },
      MuseeDeLAlambic: {
